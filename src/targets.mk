...
clean:
	...
	@$(RM) $(CFILES.LINUX:.s=.s.o)
	@$(RM) $(CPPFILES.LINUX:.s=.s.o)
	...
	@$(RM) $(CFILES.DARWIN:.s=.s.o)
	@$(RM) $(CPPFILES.DARWIN:.s=.s.o)
	...
	@$(RM) $(CFILES.WIN32:.s=.s.o)
	@$(RM) $(CPPFILES.WIN32:.s=.s.o)
	...
	@$(RM) $(CFILES.WIN64:.s=.s.o)
	@$(RM) $(CPPFILES.WIN64:.s=.s.o)
	...
	@$(RM) $(TES_CFILES.LINUX:.s=.s.o)
	@$(RM) $(TES_CPPFILES.LINUX:.s=.s.o)
	...
	@$(RM) $(TES_CFILES.DARWIN:.s=.s.o)
	@$(RM) $(TES_CPPFILES.DARWIN:.s=.s.o)
	...
	@$(RM) $(TES_CFILES.WIN32:.s=.s.o)
	@$(RM) $(TES_CPPFILES.WIN32:.s=.s.o)
	...
	@$(RM) $(TES_CFILES.WIN64:.s=.s.o)
	@$(RM) $(TES_CPPFILES.WIN64:.s=.s.o)
	...
	@$(RM) $(TES_CFILES.GBA:.s=.s.o)
	@$(RM) $(TES_CPPFILES.GBA:.s=.s.o)
